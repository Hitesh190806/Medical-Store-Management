...
public class MedicinesPanel extends JFrame {
...
String tableClicked = "";
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (quantity < 10) {
                lowStockMessage.append("Medicine: ").append(productName)
        ...
        // If any low-stock medicines were found, set up a timer to display the message after 5 seconds
        if (lowStockMessage.length() > 0) {
            Timer timer = new Timer(1000, new ActionListener() {  // 5000 milliseconds = 5 seconds
                @Override
    ...
    private void initComponents() {
        ...
        insertMedBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Medicines/pill-add-icon.png"))); // NOI18N
        ...
        updateMedBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Medicines/pill-go-icon.png"))); // NOI18N
        ...
        delMedBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Medicines/pill-delete-icon.png"))); // NOI18N
