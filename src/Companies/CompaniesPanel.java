...
public class CompaniesPanel extends JFrame {
...
String tableClicked = "";
    ...
    private void updateTable(){
        ...
        while (rs.next()) {
            ...
            Object[] row = { companyName ,country ,email ,contactNo ,address };
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        String sql = "SELECT * FROM company where company_name like '"+search+"%'";
        pst = conn.prepareStatement(sql);
        rs = pst.executeQuery();
